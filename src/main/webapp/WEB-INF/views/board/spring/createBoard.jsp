			...
			function(){
				$("#createBoard").click(
					function(){
						...
						$.ajax({
						    type: "POST",
						    url: "board.spr?cmd=CREATE_BOARD",
...
<body>
	...
	<div class="container">
		<form method="post" action="board.spr?cmd=CREATE_BOARD" id="f1">
			<div class="row">
				<div class="col-lg-7">
		...
		<div class="row">
			...
			<ul>
				<c:forEach var="table" items="${requestScope.tableList}">
					<li>
						<a href='board.spr?cmd=LIST_BOARD&board_num=${table["board_num"]}'>${table["board_disp_name"]}(${table["board_tab_name"]} : ${table["board_create_date"]})</a>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href='board.spr?cmd=DELETE_BOARD&board_num=${table["board_num"]}'>삭제</a>
					</li>
				</c:forEach>
			</ul>
		</div>
